...
---@param includeBags boolean If true, also include bag/bank items.
function CharacterMeta:FillForExport(isInspect, includeBags)
    ...
    if includeBags then
        equipmentSet:UpdateAllItems(self.unit)
    else
